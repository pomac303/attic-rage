...
ignore_gui_open ()
{
	...
	gtkutil_button (box, GTK_STOCK_NEW, 0, ignore_new_entry_clicked, 0, _("Add"));
	gtkutil_button (box, GTK_STOCK_CLOSE, 0, ignore_delete_entry_clicked, 0, _("Delete"));
	gtkutil_button (box, GTK_STOCK_CLOSE, 0, ignore_clear_entry_clicked, 0, _("Clear"));
